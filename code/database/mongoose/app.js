...
pull the most recent main into your personal branch. You can find instructions for that on server assignment #1
open Compass, and use the + symbol to "add database". You can name your database and the collection both "recipes"
click the green "Add Data" button, and select "Import JSON or CSV file"
Navigate to the recipes.json file that is in this repository, and upload it
You should now see several documents with recipes!
...
Follow how it's done in the mongoose-schemas lesson. Remember that the connection string must end with the name of your local database, not mine and not the one from the example.
