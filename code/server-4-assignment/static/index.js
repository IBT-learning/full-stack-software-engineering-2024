const fetchTodos = async () => {
    const response = await fetch("https://localhost:4000/mytodos")   //fetch returns a promise, so await waits for the promise to resolve/for the request to complete in order to return a response--- hence returns an http response object
...
/*
    ...
    - creates a list item
    - gets the title of the object out, which is the todo
    - adds the title to the created list's  item text
